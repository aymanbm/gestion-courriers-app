<x-master title="تعديل على الجهة المعنية "  css="css/gestion.css" active1="" active2="" active3="" active4="">

    <div class="text-xl bg-gradient-to-r from-blue-300 via-blue-600 to-blue-300 p-3 text-white text- font-bold text-center">تعديل على الجهة المعنية</div>
    @if ($errors->any())
        <x-alert type="red">
            <h6>الأخطاء :</h6>
    ...
    @endif
    <form action={{route('courriers.update',$lieudestinateur->id)}} method="POST" enctype="multipart/form-data">
        @csrf
        @method("PUT")
